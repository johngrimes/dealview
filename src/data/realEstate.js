...
export const realEstateToAsset = realEstate => {
  ...
  // Sale valuations are omitted from the valuations that get stored against the
  // asset.
  // The asset was never worth that much on our balance sheet - that value
  // immediately went to cash, or whatever else.
